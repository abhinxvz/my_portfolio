      ...
      <div ref={refScrollContainer}>
        ...
        >
          <div className={styles.intro}>
            ...
            >
              <Link href="mailto:abhinxv18@gmail.com" passHref>
                <Button>
        ...
        <section id="about" data-scroll-section>
          ...
          >
            <h2 className="py-16  pb-2 text-3xl font-light leading-normal tracking-tighter text-foreground xl:text-[40px]">
              ...
              <Link
                href="https://www.linkedin.com/in/abhinav-singh-a33026269/"
                target="_blank"
                className="underline"
              >
        
              </Link>{" "}
               I’m Abhinav Singh, a B.Tech CSE student specializing in Full Stack Development at UPES Dehradun,
               with hands-on experience in MERN stack technologies. Currently serving as the Design Lead at UPES Open and a core team member at GDSC-UPES,
                I am passionate about bridging design and development to create impactful digital experiences
            </h2>
