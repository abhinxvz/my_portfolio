  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.abhinxv.code${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.abhinxv.codes${router.asPath}`}
        />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">abhinxvz</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} prxwl. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
